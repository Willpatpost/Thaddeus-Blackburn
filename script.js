...
const prompts = [
  {
    ...
    choices: [
      ...
      { text: "“Perfect! I’d love to jump right in and show you how automation could fit in your company.”", points: 0 }
    ]
  },
  {
    ...
    choices: [
      ...
      { text: "“Manual tracking is outdated, and automation could solve that problem for you. I’m sure your team would prefer it.”", points: 0 }
    ]
  },
  {
    ...
    choices: [
      ...
      { text: "“I see. It sounds like a good fit for automation then, as it would reduce that labor.”", points: 0 }
    ]
  },
  {
    ...
    choices: [
      ...
      { text: "“That’s why automated software is the way to go—it takes care of inventory so you don’t have to.”", points: -1 }
    ]
  },
  {
    ...
    choices: [
      ...
      { text: "“It’s straightforward, and your team should get used to it in time. It’ll definitely save you time on manual tasks.”", points: -1 }
    ]
  },
  {
  ...
  },
  {
    ...
    choices: [
      ...
      { text: "“I can send over the contract, and we can start as soon as you’re ready.”", points: 0 }
    ]
  }
];
